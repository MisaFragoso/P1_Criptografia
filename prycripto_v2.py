...
def login():
   ...
   # Guardar la clave publica en dircetorio de usuarios (falta implementar)
        ...
        #Generamos llave/clave simetrica
           ...
           salt = salt_psaleat() #salt de 16 bytes o 128 bits  bytes: El valor de salt aleatorio.
...
#Funcion generadora del salt pseudoaleatorio para pbkdf
def salt_psaleat(longitud=16):
